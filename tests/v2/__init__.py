...
class BaseCMLTest(unittest.TestCase):
    ...
    def setup_mocks(self, m):
        ...
        m.get(self.get_api_path("labs/5eaea5/topology?exclude_configurations=False"), json=MockCMLServer.get_alt_topology)
        ...
        m.get(self.get_api_path("labs/5eaea5/state"), json="STOPPED")
