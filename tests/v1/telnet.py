...
class TelnetTests(BaseTest):
    ...
    def test_virl_telnet(self, call_mock):
        ...
        with requests_mock.mock() as m:
            ...
            m.get("http://localhost:19399/roster/rest/", json=MockVIRLServer.get_sim_roster())
            runner = CliRunner()
            runner.invoke(virl, ["telnet", "router1"])
            call_mock.assert_called_once_with(["telnet", u"1.1.1.1"])
    ...
    @patch("virl.cli.telnet.commands.call", autospec=False, side_effect=KeyError)
    ...
    @patch("virl.cli.telnet.commands.call", autospec=False, side_effect=AttributeError)
